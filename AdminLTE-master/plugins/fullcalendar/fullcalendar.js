...
newMomentProto.time = function(time) {
	...
	// Fallback to the original method (if there is one) if this moment wasn't created <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
...
/* Developed by Anunzio International */
	...
	// TODO: better code <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
...
/* Developed by Anunzio International */
	...
	sourceEl: null, // the element that will be cloned and made <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
	el: null, // the clone of `sourceEl` that will track the mouse
	parentEl: null, // the element that `el` (the clone) will be attached to

	// the initial position of el, relative to the offset parent. made <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
	top0: null,
	left0: null,
...
/* Developed by Anunzio International */
	...
	renderSegPopoverContent: function(cell, segs) {
		var view = this.view;
		var isTheme <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
		var title = cell.start.format(view.opt('dayPopoverFormat'));
		var content = $(
			'<div class="fc-header ' + view.widgetHeaderClass + '">' +
				'<span class="fc-close ' +
					(isTheme <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
				'"></span>' +
				'<span class="fc-title">' +
					htmlEscape(title) +
				'</span>' +
...
/* Developed by Anunzio International */
	...
	documentMousedown: function(ev) {
		...
		// is there a selection, and has the user made <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
...
/* Developed by Anunzio International */
	...
	var headerElement;
	var content;
	var tm; // for making theme <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
	var viewSpecCache = {};
	var currentView;
	...
	function initialRender() {
		tm = options.theme <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
		element.addClass('fc');
...
/* Developed by Anunzio International */
	...
	function _fetchEventSource(source, callback) {
		...
		for (i=0; i<fetchers.length; i++) {
			...
			if (res === true) {
				// the fetcher is in charge. made <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
				return;
			}
...
/* Developed by Anunzio International */
		...
		if (source) {
			...
			// TODO: repeat code, same code <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
			if (source.className) {
...
/* Developed by Anunzio International */
	...
	function isRangeAllowed(range, constraint, overlap, event) {
		...
		// the range must be fully contained by at least one of produced <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
		if (constraint != null) {
...
/* Developed by Anunzio International */
	...
	updateWidth: function() {
		if (this.weekNumbersVisible) {
			...
			// Record the width for cells created <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
...
/* Developed by Anunzio International */
		...
		if (!isAuto && setPotentialScroller(this.scrollerEl, scrollerHeight)) { // using scrollbars?
			...
			// doing the scrollbar compensation might have created <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
			scrollerHeight = this.computeScrollerHeight(totalHeight);
...
/* Developed by Anunzio International */
	...
	// Refreshes the horizontal dimensions of the view
	updateWidth: function() {
		// make all axis cells line up, and record the width so newly created <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
...
/* Developed by Anunzio International */
		...
		scroll();
		setTimeout(scroll, 0); // overrides any previous scroll state made by <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a>
	},
